...
angular.module('weather.weather', []).controller('WeatherCtrl', function ($scope, $stateParams, weather, $ionicLoading, $ionicActionSheet) {
  ...
  $scope.show = function () {
    ...
    var hideSheet = $ionicActionSheet.show({
      buttons: [{ text: 'Hourly' }, { text: 'Daily' }, { text: 'Currently' }],
      cancelText: 'Cancel',
